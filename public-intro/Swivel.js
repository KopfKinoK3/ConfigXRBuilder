...
var $author$project$Intro$Intro$init = function (flags) {
	return _Utils_Tuple2(
		{
			codeInput: A3($elm$core$String$replace, '?', '', flags.urlParam),
...
var $author$project$Intro$Intro$WindowSize = F2(
	function (a, b) {
...
var $author$project$Intro$Intro$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onResize($author$project$Intro$Intro$WindowSize)
			]));
};
var $author$project$Intro$Intro$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
...
var $author$project$Intro$Intro$ChangeCode = function (a) {
	return {$: 'ChangeCode', a: a};
};
var $author$project$Intro$Intro$SetLang = function (a) {
	return {$: 'SetLang', a: a};
};
...
var $author$project$Intro$Intro$gray = function (g) {
	return A3($mdgriffith$elm_ui$Element$rgb255, g, g, g);
};
var $author$project$Intro$Intro$mainColor = A3($mdgriffith$elm_ui$Element$rgb255, 255, 128, 0);
...
var $author$project$Intro$Intro$btnLook = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$padding(15),
		$mdgriffith$elm_ui$Element$Border$rounded(10),
		$mdgriffith$elm_ui$Element$Border$solid,
		$mdgriffith$elm_ui$Element$Border$color(
		$author$project$Intro$Intro$gray(255)),
		$mdgriffith$elm_ui$Element$Background$color($author$project$Intro$Intro$mainColor),
...
var $author$project$Intro$Company$company = {
	accentColor: _Utils_Tuple3(255, 128, 0),
	concatText: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Kontakt')
			])),
	concatUrl: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'https://kreativekommunikationskonzepte.de/kontakt/')
			])),
	dsgvoText: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Datenschutzerklärung')
			])),
	dsgvoUrl: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'https://kreativekommunikationskonzepte.de/datenschutzerklaerung/')
			])),
	impressText: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Impressum')
			])),
	impressUrl: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'https://kreativekommunikationskonzepte.de/impressum/')
			])),
	logoSrc: 'https://kreativekommunikationskonzepte.de/wp-content/uploads/2020/04/Logo_K3_100.png',
	logoText: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Imagefilm / 360 Grad Video / Video-Marketing / Video-Produktion')
			]))
};
...
var $author$project$Intro$Project$descr = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('de', 'Ergonomie und Schönheit vereint in einem Stuhl'),
			_Utils_Tuple2('en', 'Combine ergonomics and beauty in a chair'),
			_Utils_Tuple2('pl', 'Ergonomia i estetyka polaczona w jednym krzesle')
		]));
...
var $author$project$Intro$Project$fallBackLang = 'en';
...
var $author$project$Intro$Project$items = _List_fromArray(
	[
		{
		codeWidth: 2,
		codes: _List_fromArray(
			[
				{
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Weich (Parkett)'),
							_Utils_Tuple2('en', 'Soft (wooden floor')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', '')
						])),
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Hart (Teppich)'),
							_Utils_Tuple2('en', 'Hard (carpet)')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Rollen'),
					_Utils_Tuple2('en', 'Castors'),
					_Utils_Tuple2('pl', 'Kółka')
				])),
		item: 'Rollen'
	},
		{
		...
		codes: _List_fromArray(
			[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', 'Nylon black'),
							_Utils_Tuple2('de', 'Nylon Schwarz')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', 'Aluminium polished'),
							_Utils_Tuple2('de', 'Aluminium poliert')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Untergestell'),
					_Utils_Tuple2('en', 'Base'),
					_Utils_Tuple2('pl', 'Podstawa')
				])),
		item: 'Untergestell'
	},
		{
		...
		codes: _List_fromArray(
			[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-15 Navyblau'),
							_Utils_Tuple2('en', 'Ne-15 navy blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', 'Nemo')
						])),
				id: 'NA',
				shopId: '11793_2'
			},
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-15 Grau'),
							_Utils_Tuple2('en', 'Ne-15 gray')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-5 Rot'),
							_Utils_Tuple2('en', 'Ne-5 red')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-3 Orange'),
							_Utils_Tuple2('en', 'Ne-3 orange')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-16 Schwarz'),
							_Utils_Tuple2('en', 'Ne-16 black')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-2 Gelb'),
							_Utils_Tuple2('en', 'Ne-2 yellow')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-9 Grün'),
							_Utils_Tuple2('en', 'Ne-9 green')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-14 Graphit'),
							_Utils_Tuple2('en', 'Ne-14 graphite')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-1 Beige'),
							_Utils_Tuple2('en', 'Ne-1 beige')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ne-17 Blau'),
							_Utils_Tuple2('en', 'Ne-17 blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '68056 Grün'),
							_Utils_Tuple2('en', '68056 green')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', 'Runner')
						])),
				id: 'RA',
				shopId: '4686*317_2'
			},
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '63034 Orange'),
							_Utils_Tuple2('en', '63034 orange')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '60011 Grau'),
							_Utils_Tuple2('en', '60011 gray')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '60999 Schwarz'),
							_Utils_Tuple2('en', '60999 black')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '66063 Blau'),
							_Utils_Tuple2('en', '66063 blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '61128 Beige'),
							_Utils_Tuple2('en', '61128 beige')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '60025 Anthrazit'),
							_Utils_Tuple2('en', '60025 anthrazit')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '64089 Rot'),
							_Utils_Tuple2('en', '64089 red')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '62064 Dunkelblau'),
							_Utils_Tuple2('en', '62064 dark blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', '61130 Braun'),
							_Utils_Tuple2('en', '61130 brown')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'K3 Orange'),
							_Utils_Tuple2('en', 'K3 orange')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr108 Beige'),
							_Utils_Tuple2('en', 'Xr108 beige')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('en', 'Xtreme')
						])),
				id: 'XA',
				shopId: '4687*318_2'
			},
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr094 Grau'),
							_Utils_Tuple2('en', 'Xr094 gray')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr081 Dunkelgrau'),
							_Utils_Tuple2('en', 'Xr081 dark gray')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr420 Oliv'),
							_Utils_Tuple2('en', 'Xr420 olive')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr009 Schwarz'),
							_Utils_Tuple2('en', 'Xr009 black')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Xr026 Navyblau'),
							_Utils_Tuple2('en', 'Xr026 navy blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys071 Hellbraun'),
							_Utils_Tuple2('en', 'Ys071 light brown')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys020 Burgund'),
							_Utils_Tuple2('en', 'Ys020 burgundy')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys076 Orange'),
							_Utils_Tuple2('en', 'Ys076 orange')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys072 Gelb'),
							_Utils_Tuple2('en', 'Ys072 yellow')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys045 Grün'),
							_Utils_Tuple2('en', 'Ys045 green')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'Ys100 Blau'),
							_Utils_Tuple2('en', 'Ys100 blue')
						])),
				group: $elm$core$Dict$fromList(
					_List_fromArray(
						[
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Sitzbezug'),
					_Utils_Tuple2('en', 'Seat fabric'),
					_Utils_Tuple2('pl', 'Materiał siedziska')
				])),
		item: 'Polster'
	},
		{
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Netzrücken'),
					_Utils_Tuple2('en', 'Net'),
					_Utils_Tuple2('pl', 'Oparcie')
				])),
		item: 'Netz'
	},
		{
		...
		codes: _List_fromArray(
			[
				...
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'mit'),
							_Utils_Tuple2('en', 'with'),
							_Utils_Tuple2('pl', 'Tak')
						])),
				group: $elm$core$Dict$fromList(_List_Nil),
				id: 'Y',
				shopId: '527_3'
			},
				{
				descr: $elm$core$Dict$fromList(
					_List_fromArray(
						[
							_Utils_Tuple2('de', 'ohne'),
							_Utils_Tuple2('en', 'w/out'),
							_Utils_Tuple2('pl', 'Nie')
						])),
				group: $elm$core$Dict$fromList(_List_Nil),
				id: 'N',
				shopId: '527_2'
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Armlehnen'),
					_Utils_Tuple2('en', 'Armrests'),
					_Utils_Tuple2('pl', 'Podłokietników')
				])),
		item: 'Armlehnen'
	},
		{
		...
		descr: $elm$core$Dict$fromList(
			_List_fromArray(
				[
					_Utils_Tuple2('de', 'Lendenstütze'),
					_Utils_Tuple2('en', 'Lumbar support'),
					_Utils_Tuple2('pl', 'Podparcie lędźwiowe')
				])),
		item: 'Lenden'
	}
	]);
...
var $author$project$Intro$Intro$myFocusStyle = {backgroundColor: $elm$core$Maybe$Nothing, borderColor: $elm$core$Maybe$Nothing, shadow: $elm$core$Maybe$Nothing};
...
var $author$project$Intro$Project$sceneId = 'Swivel';
var $mdgriffith$elm_ui$Internal$Flag$overflow = $mdgriffith$elm_ui$Internal$Flag$flag(20);
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.scrollbarsY);
var $author$project$Intro$Project$shopUrlPrefix = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2('de', 'https://mdd.eu/de/sitzmobel/sava/?conf='),
			_Utils_Tuple2('en', 'https://mdd.eu/gb/seating/sava/?conf='),
			_Utils_Tuple2('pl', 'https://mdd.pl/siedziska/sava/?conf=')
		]));
...
var $author$project$Intro$Intro$translations = {
	blogText: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Unser Blogbeitrag zu dieser Technologie-Demonstration'),
				_Utils_Tuple2('en', 'Learn more about this tech demo in our blog post (auto-translated)')
			])),
	blogUrl: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'https://kreativekommunikationskonzepte.de/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/'),
				_Utils_Tuple2('en', 'https://kreativekommunikationskonzepte-de.translate.goog/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/?_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=de'),
				_Utils_Tuple2('pl', 'https://kreativekommunikationskonzepte-de.translate.goog/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/?_x_tr_sl=auto&_x_tr_tl=pl&_x_tr_hl=de'),
				_Utils_Tuple2('fr', 'https://kreativekommunikationskonzepte-de.translate.goog/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/?_x_tr_sl=auto&_x_tr_tl=fr&_x_tr_hl=de'),
				_Utils_Tuple2('nl', 'https://kreativekommunikationskonzepte-de.translate.goog/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/?_x_tr_sl=auto&_x_tr_tl=nl&_x_tr_hl=de'),
				_Utils_Tuple2('it', 'https://kreativekommunikationskonzepte-de.translate.goog/verkaufen-mit-dem-augmented-reality-stuhl-konfigurator-ar-by-apple-mit--usdz---reality/?_x_tr_sl=auto&_x_tr_tl=it&_x_tr_hl=de')
			])),
	emailBody: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Bitte informieren Sie mich über dieses aussergewöhnliche Marketing-Werkzeug und wie ich es in unsere Prozesse einbinden kann!'),
				_Utils_Tuple2('en', 'Please send me more information about this outstanding marketing tool and how to put this to work for us!')
			])),
	emailButton: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Email Anfrage'),
				_Utils_Tuple2('en', 'Email request')
			])),
	emailSubject: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Interesse an ihrem AR Produkt-Konfigurator'),
				_Utils_Tuple2('en', 'Interest in your AR product configurator')
			])),
	enterCode: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Falls Sie das Produkt bereits in AR Quick Look konfiguriert haben, geben Sie hier den dabei ermittelten Ausstattungs-Code ein. Falls nicht, starten Sie die folgende interaktive AR Experience auf Ihrem iOS-Gerät:'),
				_Utils_Tuple2('en', 'If you already configured this product in AR Quick Look, enter the resulting feature code above, or launch the following interactive AR experience on your iOS device:')
			])),
	explain: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'HINWEIS: Wir selbst vertreiben keine Produkte, demonstrieren hier nur wie wir Herstellern modernste Methoden für AR bereitstellen können. Jede Variante unseres Phantasie-Produktes Swivel wird über den Webshop-Button zu einer real verfügbaren Variante des Produktes \"Sava\" des polnischen Herstellers MDD verlinkt! Wir stehen in keiner Geschäftsbeziehung zu MDD, verwenden nur dankbar das 3D-Modell das dieser Hersteller in einer freien Lizenz öffentlich bereitgestellt hat.'),
				_Utils_Tuple2('en', 'DISCLAIMER: We do not sell products, but use this to demonstrate a most modern use case of interactive AR technology for companies. All variants of our fantasy product Swivel can be resolved as a real product variant of \"Sava\" by the polish company MDD by using the Webshop button. We are not affiliated but would like to thank MDD for making their chair 3D model publicly available.')
			])),
	groupHeader: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Materialgruppe'),
				_Utils_Tuple2('en', 'Material group')
			])),
	headline1: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Sie interessieren sich für das Produkt'),
				_Utils_Tuple2('en', 'You\'re interested in the product')
			])),
	headline2: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'in folgender Ausstattung:'),
				_Utils_Tuple2('en', 'with the following features:')
			])),
	invite: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Mit dieser AR Experience (keine Installation nötig!) können Sie auf ihrem iPhone oder iPad interaktiv Stoffe, Farben und Ausstattung zusammenstellen und kehren über einen Bestell-Link mit Ihrer Wunschkonfiguration wieder hierhin zurück.'),
				_Utils_Tuple2('en', 'Use the AR Experience below (no install needed!) on your iPhone or iPad to interactively select fabrics, colors and options. It will present you with a custom order link to return back here with the settings you choose.')
			])),
	itemHeader: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Komponente'),
				_Utils_Tuple2('en', 'Component')
			])),
	languages: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('en', 'English'),
				_Utils_Tuple2('de', 'Deutsch')
			])),
	lookHeader: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Material'),
				_Utils_Tuple2('en', 'Material')
			])),
	noMatch: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Nichts passendes gefunden für den Code '),
				_Utils_Tuple2('en', 'Nothing matches the code ')
			])),
	scan: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Für iPhone6S oder jünger, sowie iPad'),
				_Utils_Tuple2('en', 'scan with an iPad or iPhone6S (or newer)')
			])),
	webshopButton: $elm$core$Dict$fromList(
		_List_fromArray(
			[
				_Utils_Tuple2('de', 'Zum Webshop'),
				_Utils_Tuple2('en', 'visit webshop')
			]))
};
var $mdgriffith$elm_ui$Element$Font$typeface = $mdgriffith$elm_ui$Internal$Model$Typeface;
var $mdgriffith$elm_ui$Element$Font$underline = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.underline);
var $author$project$Intro$Project$urlPrefix = 'https://www.kreativekk.de/Swivel.html';
var $author$project$Intro$Intro$ShowQRcode = function (a) {
	return {$: 'ShowQRcode', a: a};
};
...
var $author$project$Intro$Intro$usdz = F2(
	function (attrs, rec) {
		return rec.supportsARQL ? A2(
			$mdgriffith$elm_ui$Element$link,
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$attribute, 'rel', 'ar')),
				attrs),
			{
				label: $mdgriffith$elm_ui$Element$html(
					A3(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(rec.imgUrl),
					...
					rec.showQRcode ? A2(
								...
								A2(
										...
										]),
									{
										...
										onPress: $elm$core$Maybe$Just(
											$author$project$Intro$Intro$ShowQRcode(false))
									}))
							]),
						_List_fromArray(
							[
								...
								_List_Nil,
								{
									label: $mdgriffith$elm_ui$Element$html(
										A2(
											...
											$elm$html$Html$text('Error while encoding to QR-Code.'),
											A2(
												$elm$core$Result$map,
												...
												$pablohirafuji$elm_qrcode$QRCode$fromString(rec.usdzUrl)))),
									onPress: $elm$core$Maybe$Just(
										$author$project$Intro$Intro$ShowQRcode(false))
								}),
								A2(
								...
								$mdgriffith$elm_ui$Element$text(rec.scanText))
							])) : A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
							[
							...
							]),
						{
							label: A2(
								...
								{description: 'ArKit Icon', src: './ArKitGlyph.svg'}),
							onPress: $elm$core$Maybe$Just(
								$author$project$Intro$Intro$ShowQRcode(true))
						})),
				attrs),
			{description: '', src: rec.imgUrl});
	});
...
var $author$project$Intro$Intro$view = function (model) {
	var stampLook = _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$padding(5),
			$mdgriffith$elm_ui$Element$Border$color($author$project$Intro$Intro$mainColor),
			$mdgriffith$elm_ui$Element$Border$width(2),
			$mdgriffith$elm_ui$Element$Border$rounded(6),
			$mdgriffith$elm_ui$Element$Font$color($author$project$Intro$Intro$mainColor)
		]);
	var maxWidth = 512;
	var langUi = A2(
			...
			function (_v13) {
				...
				return A2(
						...
						]),
					{
						...
						onPress: $elm$core$Maybe$Just(
							$author$project$Intro$Intro$SetLang(key))
					});
			},
			$elm$core$Dict$toList($author$project$Intro$Intro$translations.languages)));
	var langGet = function (ls) {
		var _v10 = A2($elm$core$Dict$get, model.userLang, ls);
		if (_v10.$ === 'Nothing') {
			var _v11 = A2($elm$core$String$split, '-', model.userLang);
			if (_v11.b) {
				var master = _v11.a;
				var _v12 = A2($elm$core$Dict$get, master, ls);
				if (_v12.$ === 'Nothing') {
					return A2(
						$elm$core$Maybe$withDefault,
						'',
						A2($elm$core$Dict$get, $author$project$Intro$Project$fallBackLang, ls));
				} else {
					var str = _v12.a;
					return str;
				}
	...
	var lookHeader = langGet($author$project$Intro$Intro$translations.lookHeader);
	var title = A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX]),
				$mdgriffith$elm_ui$Element$text(
					langGet($author$project$Intro$Intro$translations.headline1))),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text($author$project$Intro$Project$sceneId)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text(
					langGet($author$project$Intro$Project$descr))),
				model.firstVisit ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2(
					...
					A2(
						...
						A2(
							...
							' ',
							langGet($author$project$Intro$Intro$translations.invite))))) : A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX]),
				$mdgriffith$elm_ui$Element$text(
					langGet($author$project$Intro$Intro$translations.headline2)))
			]));
	var itemHeader = langGet($author$project$Intro$Intro$translations.itemHeader);
	var header = A2(
		$mdgriffith$elm_ui$Element$image,
		_List_fromArray(
			[
		...
		{
			description: langGet($author$project$Intro$Company$company.logoText),
			src: $author$project$Intro$Company$company.logoSrc
		});
	var groupHeader = langGet($author$project$Intro$Intro$translations.groupHeader);
	var gather = function (codes) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (item, f) {
					var itemDescr = langGet(item.descr);
					var currCode = A2($elm$core$String$left, item.codeWidth, f.codes);
					var matching = A2(
						$elm$core$List$filter,
						function (code) {
							return _Utils_eq(code.id, currCode);
						},
						item.codes);
					var newShopId = function () {
						if (!matching.b) {
							return $elm$core$Maybe$Nothing;
						} else {
							var code = matching.a;
					...
					var newText = $elm$core$String$concat(
						_List_fromArray(
							[
								itemDescr,
								': ',
								...
								if (!matching.b) {
									return _Utils_ap(
										langGet($author$project$Intro$Intro$translations.noMatch),
										currCode);
								} else {
									var code = matching.a;
									return A2(
					...
					var newUI = A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text(itemDescr)),
								function () {
								if (!matching.b) {
									return A2(
										$mdgriffith$elm_ui$Element$el,
					...
					return {
						codes: A2($elm$core$String$dropLeft, item.codeWidth, f.codes),
						shopIds: A2($elm$core$List$cons, newShopId, f.shopIds),
						text: _Utils_ap(
							f.text,
							_List_fromArray(
								[newText])),
			...
			{
				codes: codes,
				shopIds: _List_fromArray(
					[
						$elm$core$Maybe$Just('1981_2')
					]),
				text: _List_Nil,
				ui: _List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text(itemHeader)),
								A2(
								$mdgriffith$elm_ui$Element$row,
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$text(groupHeader)),
										A2(
										$mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
										...
										$mdgriffith$elm_ui$Element$text(lookHeader))
									]))
							]))
					])
			},
			$author$project$Intro$Project$items);
	};
	var footer = A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				A2($mdgriffith$elm_ui$Element$spacingXY, 20, 10),
				$mdgriffith$elm_ui$Element$padding(10)
			]),
		_List_fromArray(
			[
					...
					]),
				{
					label: A2(
						...
						$mdgriffith$elm_ui$Element$text(
							langGet($author$project$Intro$Company$company.impressText))),
					url: langGet($author$project$Intro$Company$company.impressUrl)
				}),
				A2(
				$mdgriffith$elm_ui$Element$newTabLink,
				_List_fromArray(
					...
					]),
				{
					label: A2(
						...
						$mdgriffith$elm_ui$Element$text(
							langGet($author$project$Intro$Company$company.dsgvoText))),
					url: langGet($author$project$Intro$Company$company.dsgvoUrl)
				}),
				A2(
				$mdgriffith$elm_ui$Element$newTabLink,
				_List_fromArray(
					...
					]),
				{
					label: A2(
						...
						$mdgriffith$elm_ui$Element$text(
							langGet($author$project$Intro$Company$company.concatText))),
					url: langGet($author$project$Intro$Company$company.concatUrl)
				}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX]),
					$mdgriffith$elm_ui$Element$text('© 2021 Kreative KommunikationsKonzepte GmbH')))
			]));
	var explainUi = A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_fromArray(
		...
		A2(
			...
			A2(
				$elm$core$String$split,
				' ',
				langGet($author$project$Intro$Intro$translations.explain))));
	var buildUrl = function (lines) {
		return 'mailto:hallo@KreativeKK.de' + ('?subject=' + ($elm$url$Url$percentEncode(
			langGet($author$project$Intro$Intro$translations.emailSubject)) + ('&body=' + $elm$url$Url$percentEncode(
			langGet($author$project$Intro$Intro$translations.emailBody) + ('\n\n' + ($author$project$Intro$Project$urlPrefix + (model.urlParam + ('\n\n' + $elm$core$String$concat(lines)))))))));
	};
	var blogLink = A2(
		$mdgriffith$elm_ui$Element$newTabLink,
		_List_fromArray(
			[$mdgriffith$elm_ui$Element$centerX]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text(
					langGet($author$project$Intro$Intro$translations.blogText))),
			url: langGet($author$project$Intro$Intro$translations.blogUrl)
		});
	return A3(
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			options: _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$focusStyle($author$project$Intro$Intro$myFocusStyle)
				])
		},
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$typeface('atkinson hyperlegible'),
						$mdgriffith$elm_ui$Element$Font$sansSerif
					])),
				$mdgriffith$elm_ui$Element$Font$color(
				$author$project$Intro$Intro$gray(0)),
				$mdgriffith$elm_ui$Element$Font$size(13)
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
				...
				[
					...
					A2(
						...
						_Utils_ap(
							...
							stampLook),
						$mdgriffith$elm_ui$Element$text('!! TECH DEMO !!'))),
					$mdgriffith$elm_ui$Element$inFront(
					A2(
						$mdgriffith$elm_ui$Element$column,
						_Utils_ap(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('First on Apple'),
								$mdgriffith$elm_ui$Element$text('AR Quick Look')
							]))),
					$mdgriffith$elm_ui$Element$inFront(
					function () {
						var _v0 = A2($elm$core$Dict$get, model.userLang, $author$project$Intro$Intro$translations.languages);
						if (_v0.$ === 'Nothing') {
							var _v1 = A2($elm$core$String$split, '-', model.userLang);
							if (_v1.b) {
								var master = _v1.a;
								var _v2 = A2($elm$core$Dict$get, master, $author$project$Intro$Intro$translations.languages);
								if (_v2.$ === 'Nothing') {
									return langUi;
								} else {
			...
			function () {
				var _v3 = $elm$core$String$uncons(model.urlParam);
				if ((_v3.$ === 'Just') && ('?' === _v3.a.a.valueOf())) {
					var _v4 = _v3.a;
					var codes = _v4.b;
					var gatherItems = gather(codes);
					var shopUrl = _Utils_ap(
						langGet($author$project$Intro$Project$shopUrlPrefix),
						A2(
							$elm$core$String$join,
							'*',
							A2(
								...
								gatherItems.shopIds)));
					var emailUrl = buildUrl(gatherItems.text);
					return A2(
						$elm$core$List$cons,
						header,
						A2(
									...
									[
										...
										_List_fromArray(
											[
												A2(
												$mdgriffith$elm_ui$Element$newTabLink,
												$author$project$Intro$Intro$btnLook,
												{
													label: $mdgriffith$elm_ui$Element$text(
														langGet($author$project$Intro$Intro$translations.emailButton)),
													url: emailUrl
												}),
												A2(
												$mdgriffith$elm_ui$Element$newTabLink,
												...
												{
													label: $mdgriffith$elm_ui$Element$text(
														langGet($author$project$Intro$Intro$translations.webshopButton)),
													url: shopUrl
												})
											])),
										explainUi,
					...
					var neededLength = $elm$core$List$sum(
						A2(
							$elm$core$List$map,
							function ($) {
								return $.codeWidth;
							...
							$author$project$Intro$Project$items));
					if (_Utils_eq(
						$elm$core$String$length(model.codeInput),
						neededLength)) {
						var gatherItems = gather(model.codeInput);
						var shopUrl = _Utils_ap(
							langGet($author$project$Intro$Project$shopUrlPrefix),
							A2(
								$elm$core$String$join,
										...
										[
												...
												[$mdgriffith$elm_ui$Element$centerX]),
											{
												label: A2(
													...
													$mdgriffith$elm_ui$Element$text('zurück zum Produkt')),
												onPress: $elm$core$Maybe$Just(
													$author$project$Intro$Intro$ChangeCode(''))
											}),
											explainUi,
											blogLink,
											footer
						...
						var imgUrl = 'https://www.kreativekommunikationskonzepte.de/wp-content/uploads/ar/Chair-Config-V1.png';
						var arLang = function () {
							var _v5 = A3($elm$core$String$slice, 0, 2, model.userLang);
							switch (_v5) {
								case 'de':
									return 'de';
								case 'en':
						...
						var usdUrl = 'https://www.kreativekommunikationskonzepte.de/wp-content/uploads/ar/Swivel_' + (arLang + ('.reality' + ('#allowsContentScaling=0' + '&canonicalWebPageURL=https://kreativekk.de/Swivel.html')));
						return _List_fromArray(
							[
								header,
								title,
								model.firstVisit ? $mdgriffith$elm_ui$Element$none : A2(
								$mdgriffith$elm_ui$Element$column,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$centerX,
									...
									[
											...
											]),
										{
											label: A2(
												...
												_List_Nil,
												$mdgriffith$elm_ui$Element$text($author$project$Intro$Project$urlPrefix + '?')),
											onChange: $author$project$Intro$Intro$ChangeCode,
										...
										A2(
											...
											A2(
												$elm$core$String$split,
												' ',
												langGet($author$project$Intro$Intro$translations.enterCode))))
									])),
								A2(
								$author$project$Intro$Intro$usdz,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$centerX,
										$mdgriffith$elm_ui$Element$width(
								...
								{
									imgUrl: imgUrl,
									scanText: langGet($author$project$Intro$Intro$translations.scan),
...
var $author$project$Intro$Intro$main = $elm$browser$Browser$element(
	{init: $author$project$Intro$Intro$init, subscriptions: $author$project$Intro$Intro$subscriptions, update: $author$project$Intro$Intro$update, view: $author$project$Intro$Intro$view});
_Platform_export({'Intro':{'Intro':{'init':$author$project$Intro$Intro$main(
	A2(
		$elm$json$Json$Decode$andThen,
		function (width) {
			return A2(
													...
													return A2(
														...
														function (height) {
															return $elm$json$Json$Decode$succeed(
																{height: height, lastUrl: lastUrl, supportsARQL: supportsARQL, thisUrl: thisUrl, urlParam: urlParam, userLang: userLang, width: width});
														},
														A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$float));
												},
												A2($elm$json$Json$Decode$field, 'lastUrl', $elm$json$Json$Decode$string));
										},
										A2($elm$json$Json$Decode$field, 'supportsARQL', $elm$json$Json$Decode$bool));
								},
								A2($elm$json$Json$Decode$field, 'thisUrl', $elm$json$Json$Decode$string));
						},
						A2($elm$json$Json$Decode$field, 'urlParam', $elm$json$Json$Decode$string));
				},
				A2($elm$json$Json$Decode$field, 'userLang', $elm$json$Json$Decode$string));
		},
